...
#include "list-lib.h"
 ...
 /*
	 CreateList -	Allocates storage for a structure of type LIST and
					 ...
					 on the heap.
 */
LIST* __cdecl CreateList(long n)
{
	LIST *NewList;
...
*/
void __cdecl DestroyList(LIST *List)
{
	...
	if (List->Count == 0 || List->ListHead == NULL) return;
...
*/
long __cdecl GetCount(LIST *List)
{
	return List->Count;
}
...
*/
int __cdecl InsertEntry(LIST *List, void *Data, unsigned long Size, int(*function)(void *Data1, void *Data2))
{
...
*/
entry_t* __cdecl FindEntry(LIST *List, void *Data, int(*function)(void *Data1, void *Data2))
{
	entry_t *CurrentEntry = NULL;
...
*/
void* __cdecl FindEntryData(LIST *List, void *Data, int(*function)(void *Data1, void *Data2))
{
	entry_t *CurrentEntry = NULL;
...
*/
int __cdecl DeleteEntry(LIST *List, void *Data, int(*function)(void *Data1, void *Data2))
{
	entry_t *CurrentEntry = NULL;
	entry_t *PrevEntry = NULL;
...
*/
void __cdecl TraverseList(LIST *List, void(*function)(void *Data))
{
